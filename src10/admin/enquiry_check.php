...
<head>
<meta charset="utf-8">
<title>admin/check enquiry</title>
<style type="text/css">
	body{
		margin:0px;
		padding:0px;
    ...
    <div id="container">
        ...
        <div id="container_right">
        	<div id="container_right_upperdiv">
				...
				<div id="tablediv">
					<form action="enquiry_check.php" method="POST">
					<table>
						<tr>
							<td colspan="3"><h3>Check Enquiry</h3></td>
						</tr>
						<tr>
							<td>Id:</td>
						...
						<tr>
							<td><form action="enquiry_delete.php"><button> Delete</button></form></td>
							<td><form action="enquiry_update.php"><button> Update</button></form></td>
        	...
        	<div id="container_right_lowerdiv">
				...
				if(isset($_POST["keyword"])){
					...
					$result=$conn->query("select * from enquiry where userid LIKE '%{$keyword}%'");
					echo'<br/>';
					echo'<table class="resulttable">';
					echo'<tr><th>enquiryid</th><th>Full Name</th><th>Email ID</th><th>Contact</th><th>Subject</th><th>Comments</th></tr>';
					foreach($result as $r)
					{
						echo'<tr>';
						echo'<td>'.$r['id'].'</td>';
