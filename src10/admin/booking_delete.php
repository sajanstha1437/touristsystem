        ...
        <div id="container_right">
        	<div id="container_right_upperdiv">
				...
				<div id="tablediv">
					...
					<table>
						<tr>
							<td colspan="3"><h3>Delete Booking</h3></td>
						</tr>
						<tr>
							<td>userId:</td>
						...
						<tr>
							<td colspan="3"><button> Delete</button></td>
						
						</form>
						</tr>
						<tr>
							<td ><form action="booking_check.php"><button> Check Bookings</button></form></td>
						
							<td><form action="booking_update.php"><button> Update Bookings</button></form></td>
        	...
        	<div id="container_right_lowerdiv">
				...
				<?php
					...
					{
						$userid=$_POST["userid"];
						$stat=$conn->prepare("delete from booking where userid='{$userid}'");
						$stat->execute(array(
						":userid"=>$userid,
						));
						...
						if ($result==1){
							...
							echo 'userid :';
							echo '<a href=:read.php?id='.$userid.'">'.$userid.'</a>';
						}
						else
						{
