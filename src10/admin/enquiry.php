        	...
        	<div id="container_right_upperdiv">
				<div id="tablediv">
					<table>
						...
						<tr>
							<td><a href="booking_check.php"><button> Check bookings</button></a></td>
								<td><a href="booking_delete.php"><button> Delete bookings</button></a></td>
								<td><a href="booking_update.php"><button> Update bookings</button></a></td>
